...
CFLAGS = -g -pthread -Wall -lncursesw 
...
default: ui.o user_inp.o utils.o matrix.o seed.o main.o
	$(CC) $(BUILD_DIR)/ui.o $(BUILD_DIR)/user_inp.o $(BUILD_DIR)/utils.o $(BUILD_DIR)/matrix.o $(BUILD_DIR)/seed.o $(BUILD_DIR)/main.o $(CFLAGS) -o $(BIN_DIR)/seagull
